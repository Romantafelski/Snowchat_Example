...
# MAX_INPUTS = 600 because gpt-3.5-turbo only allows 3 per minute.

openai.api_key = st.secrets["OPENAI_API_KEY"]

#Limit of 5 inputs because gpt-3.5-turbo only allows 60 per min for paid users.
MAX_INPUTS = 60
chat_history = []
...
st.title("SnowChat")
st.caption("An easier way to navigate your Snowflake databases. Ask your questions in typical English language and our bot will provide the answers.")
